    ...
    <main class="fix">
        ...
        <div class="tp-hero-area tp-hero-five__ptb-5 p-relative grey-bg-2 fix">
            <div class="tp-hero-five__shape-2">
                <img src="{{ asset('/') }}assets/img/hero/hero-circle-5-1.png" alt="">
            </div>
            <div class="tp-hero-five__shape-3">
                <img src="{{ asset('/') }}assets/img/hero/hero-circle-5-2.png" alt="">
            </div>
            <div class="tp-hero-five__shape-4">
                <img src="{{ asset('/') }}assets/img/hero/hero-circle-5-3.png" alt="">
            </div>
            <div class="container">
                        ...
                        <div class="tp-hero-five-section-wrap">
                            <div class="tp-hero-five-section-box z-index">
                                <h3 class="tp-hero-title-5 hero-text-anim-2">
                                    <i>
                                        <i class="child-2">
                                            Document <span class="child-1 p-relative">Optimizer
                                    ...
                                    <i><i class="child-2"><span class="child-2">Management</span> With
                                            <br></i></i>
                                    <i><i class="child-2">Aritificial Intelligence</i></i>
                                </h3>
                            </div>
                            <div class="tp-hero-five-btn-box d-flex align-items-center wow tpfadeUp" data-wow-duration=".9s"
                                data-wow-delay=".7s">
                                <a class="tp-btn-blue-lg purple-bg circle-effect mr-15 mb-20" href="javascript:void(0)">Get
                                    Started</a>
                                <a class="tp-btn-grey mb-20" href="javascript:void(0)">Try a Demo</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {{-- <div class="tp-hero-five-2-thumb-main p-relative">
                <div class="tp-hero-five-2-thumb">
                    <img class="tp-hero-five-2-thumb-inner" src="{{ asset('/') }}assets/img/hero/hero-shape-5-1-1.png"
                        alt="">
                </div>
                <div class="tp-hero-five-2-sub-img-1 d-none d-md-block">
                    <img src="{{ asset('/') }}assets/img/hero/home-shape-1-1.png" alt="">
                </div>
                <div class="tp-hero-five-2-sub-img-2 d-none d-md-block">
                    <img src="{{ asset('/') }}assets/img/hero/home-shape-1-2.png" alt="">
                </div>
            </div> --}}
        </div>
        <!-- tp-hero-area-end -->
        ...
        <!-- tp-video-area-start -->
        <div class="tp-vedio-area p-relative pt-120 mb-4">
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="tp-vedio-wrap">
                            <img src="{{ asset('assets/img/about/curl.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="tp-service-area tp-services-five-item-bg-color p-relative fix">
            <div class="container-fluid p-0">
                <div class="tp-service-five-bg" data-background="{{ asset('/') }}assets/img/service/service-5-1-bg.png">
                </div>
                <div class="row g-0 align-items-center">
                    <div class="col-lg-6">
                        <div class="tp-service-five-section-box">
                            <h3 class="tp-section-title-5 pb-15"><span>Related converters</span>
                            </h3>
                            <p class="pb-20">We offer a wide range of converters beyond just Compress PDF that you might
                                find useful. Our comprehensive collection of tools is designed to make conversions quick and
                                easy!
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="row g-0">
                                ...
                                <div class="tp-service-five-item z-index">
                                    ...
                                    <div class="tp-service-five-wrapper">
                                        <div class="tp-service-five-icon">
                                            <img src="{{ asset('/') }}assets/img/service/sv-icon-5-1.png" alt="">
                                        </div>
                                        <div class="tp-service-five-content">
                                            <h3 class="tp-service-five-title-sm"><a href="javascript:void(0)">Flatten PDF
                                                    API</a>
                                            </h3>
                                            <p>
                                                Flatten PDF API is a tool that allows you to lock PDF form fields and
                                                prevent further modifications of the values entered into the PDF forms. It
                                                also provides an option to prevent text selection, copying, and extraction
                                                by turning the textual symbols into vectorial paths to make the PDF
                                                read-only while preserving the original vectorial PDF quality.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="tp-service-five-btn text-end">
                                        <a href="javascript:void(0)"><i class="far fa-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="tp-service-five-item z-index">
                                    ...
                                    <div class="tp-service-five-wrapper">
                                        <div class="tp-service-five-icon">
                                            <img src="{{ asset('/') }}assets/img/service/sv-icon-5-2.png" alt="">
                                        </div>
                                        <div class="tp-service-five-content">
                                            <h3 class="tp-service-five-title-sm"><a href="javascript:void(0)">Rasterize PDF
                                                    API</a>
                                            </h3>
                                            <p>
                                                The PDF Rasterize API transforms vector-based PDF into single-layer,
                                                image-like PDF, ensuring consistent rendering across various platforms and
                                                enhancing compatibility, especially with complex graphics. Rasterizing
                                                protects document content by making text and vector elements uneditable,
                                                making it ideal for creating read-only documents.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="tp-service-five-btn text-end">
                            ...
                            <div class="col-md-6">
                                <div class="tp-service-five-item z-index">
                                    ...
                                    <div class="tp-service-five-wrapper">
                                        <div class="tp-service-five-icon">
                                            <img src="{{ asset('/') }}assets/img/service/sv-icon-5-3.png" alt="">
                                        </div>
                                        <div class="tp-service-five-content">
                                            <h3 class="tp-service-five-title-sm"><a href="javascript:void(0)">Repair PDF
                                                    API</a>
                                            </h3>
                                            <p>
                                                PDF Repair API is designed to restore corrupt and damaged PDF files
                                                efficiently. The API analyzes and repairs PDF documents, recovering them
                                                either partially or entirely based on the damage extent.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="tp-service-five-btn text-end">
                            ...
                            <div class="col-md-6">
                                <div class="tp-service-five-item z-index">
                                    ...
                                    <div class="tp-service-five-wrapper">
                                        <div class="tp-service-five-icon">
                                            <img src="{{ asset('/') }}assets/img/service/sv-icon-5-4.png"
                                                alt="">
                                        </div>
                                        <div class="tp-service-five-content">
                                            <h3 class="tp-service-five-title-sm"><a href="javascript:void(0)">Squeeze PDF
                                                    API</a>
                                            </h3>
                                            <p>
                                                The API compresses up to 20% of PDF size for easier shareability without
                                                compromising quality in seconds.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="tp-service-five-btn text-end">
                    ...
                    <div class="col-xl-5 col-lg-5 wow tpfadeLeft" data-wow-duration=".9s" data-wow-delay=".3s">
                        <div class="tp-plan-section-box">
                            <div class="tp-plan-section-icon pb-30">
                                <img src="{{ asset('/') }}assets/img/cta/cta-title-icon-2.png" alt="">
                            </div>
                            <h3 class="tp-section-title-5 text-black pb-25">Integrate within minutes</h3>
                        </div>
                        <p class="tp-cta-desc pb-25">Our user-friendly interactive demo enables you to easily set up and
                            test the conversion from your account dashboard with just a few simple clicks</p>
                    ...
                    <div class="col-xl-7 col-lg-7  wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".5s">
                        <div class="tp-plan-2-img-box p-relative">
                            <div class="tp-plan-2-img-1">
                                <img src="{{ asset('/') }}assets/img/plan/plan-1-1.png" alt="">
                            </div>
                            <div class="tp-plan-2-img-2 d-none d-sm-block">
                                <img src="https://www.convertapi.com/static/img/integration/set-up-conversion.png"
                                    alt="">
                            </div>
                            <div class="tp-plan-2-img-3">
                                <img src="https://www.convertapi.com/static/img/integration/convert-online.png"
                                    alt="">
                            </div>
                            <div class="tp-plan-2-img-4">
                                <img src="https://www.convertapi.com/static/img/integration/code-snippet.png"
                                    alt="">
                            </div>
                        </div>
                    </div>
        ...
        <div class="tp-testimonial-area pt-130 pb-130 fix"
            data-background="{{ asset('/') }}assets/img/testimonial/testi-bg-5-1.jpg">
            <div class="container">
                                        ...
                                        <div class="tp-testimonial-five-item">
                                            <div
                                                ...
                                                <div class="tp-testimonial-five-brand d-none d-sm-block">
                                                    <img src="{{ asset('/') }}assets/img/testimonial/testi-logo-5-2.png"
                                                        alt="">
                                                </div>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tp-testimonial-five-item">
                                            <div
                                                ...
                                                <div class="tp-testimonial-five-brand d-none d-sm-block">
                                                    <img src="{{ asset('/') }}assets/img/testimonial/testi-logo-5-1.png"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="tp-testimonial-five-content">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tp-testimonial-five-item">
                                            <div
                                                ...
                                                <div class="tp-testimonial-five-brand d-none d-sm-block">
                                                    <img src="{{ asset('/') }}assets/img/testimonial/testi-logo-5-3.png"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="tp-testimonial-five-content">
                        ...
                        <div class="tp-feature-five-wrapper">
                            <div class="tp-feature-five-item tp-feature-five-item-1 text-center z-index">
                                <div class="tp-feature-five-icon p-relative">
                                    <img src="{{ asset('/') }}assets/img/feature/fea-icon-5-1.png" alt="">
                                    <div class="tp-feature-five-shape-color tp-feature-five-shape-color-1">
                                    </div>
                                </div>
                                ...
                                <div class="tp-feature-five-btn">
                                    <a class="tp-btn-purple" href="javascript:void(0)">Learn More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="tp-feature-five-wrapper">
                            <div class="tp-feature-five-item tp-feature-five-item-2 text-center z-index">
                                <div class="tp-feature-five-icon p-relative">
                                    <img src="{{ asset('/') }}assets/img/feature/fea-icon-5-2.png" alt="">
                                    <div class="tp-feature-five-shape-color tp-feature-five-shape-color-2">
                                    </div>
                                </div>
                                <div class="tp-feature-five-content">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="tp-feature-five-wrapper">
                            <div class="tp-feature-five-item tp-feature-five-item-3 text-center z-index">
                                <div class="tp-feature-five-icon p-relative">
                                    <img src="{{ asset('/') }}assets/img/feature/fea-icon-5-3.png" alt="">
                                    <div class="tp-feature-five-shape-color tp-feature-five-shape-color-3">
                                    </div>
                                </div>
                                <div class="tp-feature-five-content">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="tp-feature-five-wrapper">
                            <div class="tp-feature-five-item tp-feature-five-item-4 text-center z-index">
                                <div class="tp-feature-five-icon p-relative">
                                    <img src="{{ asset('/') }}assets/img/feature/fea-icon-5-4.png" alt="">
                                    <div class="tp-feature-five-shape-color tp-feature-five-shape-color-4">
                                    </div>
                                </div>
                                <div class="tp-feature-five-content">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="tp-feature-five-link text-center">
                            <span>Check out all of our <a href="javascript:void(0)">All features</a></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- tp-cta-area-start -->
        <div class="tp-cta-area pt-120 pb-120 mb-120 tp-cta-five-bg p-relative mt-4"
            data-background="{{ asset('/') }}assets/img/cta/cta-bg-5-1.png">
            <div class="tp-cta-five-shape-1 d-none d-md-block">
                <img src="{{ asset('/') }}assets/img/cta/cta-shape-5-1.png" alt="">
            </div>
            <div class="tp-cta-five-shape-2 d-none d-md-block">
                <img src="{{ asset('/') }}assets/img/cta/cta-shape-5-2.png" alt="">
            </div>
                ...
                <div class="row g-0">
                    <div class="col-12">
                        <div class="tp-cta-five-section-box text-center">
                            ...
                            <h3 class="tp-section-title-5 pb-30">Supercharge Your Growing <br>
                                <span>Business</span>
                            </h3>
                            <div class="tp-cta-five-btn">
                                <a class="tp-btn-yellow-lg circle-effect" href="javascript:void(0)">Get Started
                                    Free</a>
                            </div>
                        </div>
                    </div>
