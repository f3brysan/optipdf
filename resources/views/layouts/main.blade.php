                ...
                <div class="row g-0 align-items-center">
                    <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-6">
                        <div class="header-bottom__logo">
                            <a href="index.html"><img src="{{ asset('/') }}assets/img/logo/logo-new.png"
                                    alt=""></a>
                        </div>
                    </div>
        ...
        <div class="tpoffcanvas-area">
            <div class="tpoffcanvas">
                ...
                <div class="tpoffcanvas__instagram text-center">
                    ...
                    <a href="#"><img src="{{ asset('/') }}assets/img/project/project-inner-4.jpg"
                            alt=""></a>
                    <a href="#"><img src="{{ asset('/') }}assets/img/project/project-inner-5.jpg"
                            alt=""></a>
                    <a href="#"><img src="{{ asset('/') }}assets/img/project/project-inner-6.jpg"
                            alt=""></a>
                    <a href="#"><img src="{{ asset('/') }}assets/img/project/project-inner-7.jpg"
                            alt=""></a>
                </div>
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 pb-30  wow tpfadeUp" data-wow-duration=".9s"
                                    ...
                                    <div class="tp-footer__widget footer-widget-3 footer-widget-5 footer-col-3-1">
                                        <div class="tp-footer__logo mb-25">
                                            <a href="index.html">
                                                <img src="{{ asset('/') }}assets/img/logo/logo-new.png"
                                                    alt="">
                                            </a>
                                        </div>
